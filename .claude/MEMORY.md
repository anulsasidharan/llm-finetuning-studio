...
- Active Week: 2
- Last completed task: PHASE1-WEEK2-003 — all ORM models (user, fine_tune_job, dataset, experiment, model_registry) (2026-06-18)
- Next task: PHASE1-WEEK2-004 — Alembic config + initial migration
